...
namespace PACModbusSimulator
{
    public class Int32Variable : VariableBase
    {
        ...
        public Int32Variable(String name, Int32 offset, Boolean shouldInsertToHR = true, Boolean shouldInsertToIR = true, Boolean randomGeneration = false, Boolean autoCalculation = false) :
            base(name, offset, shouldInsertToHR, shouldInsertToIR, randomGeneration, autoCalculation)
        {
            this.Data = new UInt16[] { 0, 0 };
        }

        private Int32 _randomMax = 0;
        /// <summary>
        /// Random max value
        /// </summary>
        ...
        protected override object ConvertDataToValue(UInt16[] Data)
        {
            ...
            return BitConverter.ToInt32(allBytes, 0);
        }
        ...
        {
            var allBytes = BitConverter.GetBytes(Convert.ToInt32(value));
        ...
        {
            var userControlToReturn = new Int32VariableUserControl();
